...
> Esta explicación es de la práctica 4 de despliegue de aplicaciones web sobre el análisis de GitHub Actions, donde he elegido la **Opción B** (explicacion de un action de un tercero).
...
* **¿Qué problema resuelve?** Automatiza la subida de archivos vía FTP. Permite tener una página web donde cualquiera puede visualizar y ejecutar los ejercicios actualizada al día automáticamente con el repositorio.
...
* **`runs-on: ubuntu-latest`**: La acción se ejecuta en una máquina virtual de Linux que nos presta GitHub.

**c) Los pasos (`steps`)**
El trabajo tiene solo dos pasos principales:
...
2. **Sync Files (el deploy FTP):**
Aquí es donde uso la action de terceros. Le paso mis credenciales para que se conecte.
